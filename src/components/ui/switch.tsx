...
const themeBg: Record<Themes, string> = {
  ...
  orange: "data-[state=checked]:bg-orange-500 data-[state=unchecked]:bg-orange-500/15",
  amber: "data-[state=checked]:bg-amber-500 data-[state=unchecked]:bg-amber-500/15",
  yellow: "data-[state=checked]:bg-yellow-500 data-[state=unchecked]:bg-yellow-500/15",
  lime: "data-[state=checked]:bg-lime-500 data-[state=unchecked]:bg-lime-500/15",
  green: "data-[state=checked]:bg-green-500 data-[state=unchecked]:bg-green-500/15",
  emerald: "data-[state=checked]:bg-emerald-500 data-[state=unchecked]:bg-emerald-500/15",
  ...
  indigo: "data-[state=checked]:bg-indigo-500 data-[state=unchecked]:bg-indigo-500/15",
  violet: "data-[state=checked]:bg-violet-500 data-[state=unchecked]:bg-violet-500/15",
  purple: "data-[state=checked]:bg-purple-500 data-[state=unchecked]:bg-purple-500/15",
  fuchsia: "data-[state=checked]:bg-fuchsia-500 data-[state=unchecked]:bg-fuchsia-500/15",
  ...
  neutral: "data-[state=checked]:bg-neutral-500 data-[state=unchecked]:bg-neutral-500/15",
...
>(({ className, theme, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      theme ? themeBg[theme] : "data-[state=checked]:bg-primary data-[state=unchecked]:bg-input",
      className,
    )}
    {...props}
    ref={ref}
