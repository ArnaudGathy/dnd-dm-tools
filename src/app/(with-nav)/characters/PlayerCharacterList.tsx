...
import { getFilteredCharactersByOwner, getNumberOfCharactersByOwner } from "@/lib/api/characters";
...
export default async function PlayerCharacterList({
  ...
  const myCampaignCharacters = characters.filter((character) => character.owner !== userMail);
